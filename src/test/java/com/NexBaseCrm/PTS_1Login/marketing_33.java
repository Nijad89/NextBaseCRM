...
public class marketing_33 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        login.sendKeys(marketing33Login);
        Thread.sleep(2000);
        ...
        if (actualTitle.equals(expectedTitle)){
            System.out.println("marketing33Login successful Title verification passed");
        }else{
            System.out.println("marketing33Login Failed Title verification failed");
        }
